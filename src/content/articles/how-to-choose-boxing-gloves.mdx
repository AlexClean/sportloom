...
<article className="mx-auto max-w-3xl px-4 py-8">
    ...
    <section id="related" className="mt-12 border-t pt-8">
        ...
        <ul className="mt-4 space-y-2">
            ...
            <li className="opacity-80"> Top 5 Boxing Gloves Under $100 <span className="ml-2 inline-block rounded bg-yellow-100 px-2 py-0.5 text-xs text-yellow-900">Coming soon</span></li>
            <li className="opacity-80">Best Boxing Gloves for Heavy Bag Training <span className="ml-2 inline-block rounded bg-yellow-100 px-2 py-0.5 text-xs text-yellow-900">Coming soon</span></li>
        </ul>
    </section>
